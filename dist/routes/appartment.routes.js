...
router.post('/appartment-create', AdminVerifyTokenMiddleware, uploadImages.fields([{ name: 'm02_image', maxCount: 1 }]), validateDataMiddleWare(apartmentCreateSchema), apartmentCreateController);
router.put('/appartment-update/:id', AdminVerifyTokenMiddleware, uploadImages.fields([{ name: 'm02_image', maxCount: 1 }]), validateDataMiddleWare(apartmentUpdateSchema), apartmentUpdateController);
