...
export const UserVerifyTokenController = async (req, res, next) => {
    try {
...
export const userCreateController = async (req, res, next) => {
    try {
...
export const userReadController = async (req, res, next) => {
    try {
        const { id } = req.params;
